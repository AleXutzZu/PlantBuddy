...
from server.service.workflow import predict_node, search_web_node, write_article, structure_node
import lancedb
...
#     return LanceDB(
#         connection=db,
#         embedding=OllamaEmbeddings(model=OLLAMA_MODEL_LLAMA3, base_url="http://llm:11434"),
...
def get_workflow():
    ...
    workflow.add_edge("search", "structure")
